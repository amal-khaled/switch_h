                                ...
                                MaterialPageRoute(
                                  //Todo try to include parameters to trigger data of category
                                    builder: (context) => SpecificCategoryProducts(
                                        getApiString(context, Provider.of<HomeProvider>(context,
                                            listen: false)
                                            .categoryArabicNameToSubcategoriesArabicNamesMap[
                                        categoriesList[index].categoryTitle], Provider.of<HomeProvider>(context,
                                            listen: false)
                                            .categoryEnglishNameToSubcategoriesEnglishNamesMap[
                                        categoriesList[index].categoryEnglishTitle]),
                                        getApiString(context, Provider.of<HomeProvider>(context, listen: false).categoryArabicNameToSubcategoriesIDsMap[categoriesList[index].categoryTitle], Provider.of<HomeProvider>(context, listen: false).categoryEnglishNameToSubcategoriesIDsMap[categoriesList[index].categoryEnglishTitle]),
