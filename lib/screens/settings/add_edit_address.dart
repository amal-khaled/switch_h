...
import '../../real_api/load_data.dart';
...
final TextEditingController floorNumberController = new TextEditingController();
...
class AddOrEditUserAddress extends StatefulWidget {
  final bool isPayable;
  const AddOrEditUserAddress({Key key, this.isPayable}) : super(key: key);

  @override
  State<AddOrEditUserAddress> createState() => _AddOrEditUserAddressState();
}

class _AddOrEditUserAddressState extends State<AddOrEditUserAddress> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText:
                                AppLocalizations.of(context).translate("gadda"),
                            labelStyle: TextStyle(
                              color: Colors.grey,
                              fontFamily: usedFont,
                              fontWeight: FontWeight.w400,
                        ...
                        Visibility(
                          visible: userPropertyType == PropertyType.apartment,
                          child: TextFormField(
                        ...
                        Visibility(
                          visible: userPropertyType == PropertyType.office,
                          child: TextFormField(
